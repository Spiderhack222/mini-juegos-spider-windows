...
int juego (int numero, int xmax, int ymax, int movimientos,char laberinto [6][40][60])
{
	...
	while (1)
	{
		...
		for (n=0;n<ymax;n++)// Una vez le�do todo el laberinto, va fila y columna imprimi�ndolo por pantalla
		{
			for (i=0; i<xmax; i++)
			{
...
void estadisticas ()
{
	...
	{
		numLaberinto [nivel[n]]++;// si el nivel de� primero es 1 suma 1 al primer laberinto
